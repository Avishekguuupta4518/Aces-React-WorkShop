    ...
    <div>
      <footer>
            ...
            <div className="-mx-4 flex flex-wrap justify-between">
              <div className="px-4 my-4 w-full xl:w-1/5">
                ...
                <p className="text-justify">
                  BlogApp is a sleek and modern platform where multiple authors
                  share their unique stories and insights through beautifully
                  designed blog posts.
                </p>
              </div>
        ...
        <div className="bg-indigo-700 py-4 text-gray-100">
          <div className="container mx-auto px-4 flex flex-col items-center justify-center space-y-2 text-center">
            <div>Copyright © 2025. Made with ❤️ by Avishek.</div>
          </div>
        </div>
      </footer>
    </div>
